...
void MainView::createShaderPrograms() {
  ...
  // Add shader for reflection lines
  reflectionShaderProg = new QOpenGLShaderProgram();
  reflectionShaderProg->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/vertshader.glsl");
  reflectionShaderProg->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/reflectionshader.glsl");

  reflectionShaderProg->link();
  ...
  uniReflectionDensity = glGetUniformLocation(reflectionShaderProg->programId(), "reflectiondensity");
...
void MainView::updateUniforms() {
  ...
  // Update refleciton uniform
  glUniform1f(uniReflectionDensity, rDensity);
...
void MainView::paintGL() {
  ...
  if (modelLoaded) {
    ...
    QOpenGLShaderProgram *shaderProg = showRefl ? reflectionShaderProg : mainShaderProg;
